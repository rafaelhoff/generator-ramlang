 ...
 *
 * @param {String} apiModuleName - The name of the application module.
 ...
 */
module.exports.generate = function(apiModuleName, ramlResourceObj, withModule, selectedMediaTypeExtension) {
  var moduleName = apiModuleName + (apiModuleName != 'api' ? '-api' : '');
  ...
  ramlResourceObj.methods = methods.generate(ramlResourceObj, selectedMediaTypeExtension, apiModuleName);
